...
namespace Domain
{
    ...
    /// </summary>
    public class MyConfig : ApplicationDbContext
    {
        ...
        public static IDbConnection DefaultConnection
        {
            get
            {
                ...
                //数据库类型
                string action = ConfigurationSettings.AppSettings["daoType"];
                switch (action)
                {
                    //case "oracle":
                    ...
                    case "mssql":
                      ...
                      //  DefaultConnectionString = ConfigurationSettings.AppSettings["SqlConnectionString"].ConnectionString;
                        break;
                    default:
                        break;
                }
